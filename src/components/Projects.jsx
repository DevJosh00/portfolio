...
const Projects = () => {
 ...
 {/**project One */}
      <div>
                              {/**ProjectContainer */}
                              {/** ProjectCards */}
            <div  style={{backgroundImage:`url(${crypt})`}} className='shadow-lg shadow-[#040a16] group rounded-md flex flex-col justify-center items-center mx-auto content-div sm:hover:scale-110 h-[180px] md:h-[230px] sm:h-[230px]'>
              {/**HoverEffects */}
 ...
 {/**project Two */}
      <div>
                              {/**ProjectContainer */}
                              {/** ProjectCards */}
            <div  style={{backgroundImage:`url(${Todo})`}} className='shadow-lg shadow-[#040a16] group rounded-md flex flex-col justify-center items-center mx-auto content-div sm:hover:scale-110 h-[180px] md:h-[230px] sm:h-[230px]'>
              {/**HoverEffects */}
      ...
      <div>
                              {/**ProjectContainer */}
                              {/** ProjectCards */}
            <div  style={{backgroundImage:`url(${port})`}} className='shadow-lg shadow-[#040a16] group rounded-md flex flex-col justify-center items-center mx-auto content-div sm:hover:scale-110 h-[180px] md:h-[230px] sm:h-[230px]'>
              {/**HoverEffects */}
      ...
      <div>
                              {/**ProjectContainer */}
                              {/** ProjectCards */}
            <div  style={{backgroundImage:`url(${ems})`}} className='shadow-lg shadow-[#040a16] group rounded-md flex flex-col justify-center items-center mx-auto content-div sm:hover:scale-110 h-[180px] md:h-[230px] sm:h-[230px]'>
              {/**HoverEffects */}
              <div className='opacity-100 duration-500 text-black font-sans '> 
                  <span className='text-xl font-bold text-center'>
      ...
      <div>
                              {/**ProjectContainer */}
                              {/** ProjectCards */}
            <div  style={{backgroundImage:`url(${crud})`}} className='shadow-lg shadow-[#040a16] group rounded-md flex flex-col justify-center items-center mx-auto content-div sm:hover:scale-110 h-[180px] md:h-[230px] sm:h-[230px]'>
              {/**HoverEffects */}
              <div className='opacity-100 duration-500 text-black font-sans '> 
                  <span className='text-xl font-bold text-center'>
                    <p className='text-center text-3xl py-2  bg-blue-300 shadow-xl group-hover:shadow-white px-4 shadow-black rounded-lg'>BioGeCen[EMS]</p>
